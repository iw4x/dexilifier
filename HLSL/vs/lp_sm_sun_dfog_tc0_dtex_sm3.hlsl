...
float4 var_tex1 = vin.normal / float4(127, 127, 127, 255) + (1 / float4(-1, -1, -1, 1.328125));
	...
	var_tex1.x = dot(fogSunDir.xyz, var_tex4.xyz);
	var_tex1.y = dot(var_tex4.xyz, var_tex4.xyz);
	...
	var_tex4.xw = fogSunConsts.xw;
	var_tex1.yz = var_tex1.y * var_tex4.wx + fogConsts.w;
