...
half3 var_colormap = (tex2D(colorMapSampler, inputVx.texcoord.xy)).xyz;
	...
	var_lightmapsecondary.rgb = var_colormap * var_lightmapsecondary.rgb - fogColorLinear.xyz;

	outColor.xyz = inputVx.texcoord1.w * var_lightmapsecondary.rgb + fogColorLinear.xyz;
	outColor.w = 1;
