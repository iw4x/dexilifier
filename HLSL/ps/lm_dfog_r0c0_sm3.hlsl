...
half4 var_lightmapsecondaryA = tex2D(lightmapSamplerSecondary, var_C.zw);
	var_C.y = var_lightmapsecondaryA.a;
	...
	var_lightmapsecondary.xyz = var_lightmapsecondaryA.rgb * var_lightmapsecondary.w + var_lightmapsecondary.xyz;
...
half3 var_colormap = (tex2D(colorMapSampler, inputVx.texcoord.xy)).xyz;
	...
	var_lightmapsecondary.w = dot(fogSunDir.xyz, var_lightmapsecondaryA.rgb);
	...
	var_lightmapsecondaryA.rgb = var_lightmapsecondary.w * var_lightmapsecondaryA.rgb + fogColorLinear.xyz;
	var_lightmapsecondary.xyz = var_colormap * var_lightmapsecondary.xyz + (-var_lightmapsecondaryA.rgb);

	outColor.xyz = inputVx.texcoord1.w * var_lightmapsecondary.xyz + var_lightmapsecondaryA.rgb;
	outColor.w = 1;
