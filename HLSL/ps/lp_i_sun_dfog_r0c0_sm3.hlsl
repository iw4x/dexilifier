...
half3 var_D = var_outr.xyz * lightingLookupScale.xyz;
	...
	var_outr.w = 1 / var_C;
	var_outr.yzw = var_D * var_outr.w + inputVx.texcoord6;
	
half4 var_modellighting = tex3D(modelLightingSampler, var_outr.yzw);
	var_outr.yzw = var_modellighting.xyz + var_modellighting.xyz;
	var_modellighting.xyz = var_outr.xxx * lightDiffuse.xyz;
	var_outr.yzw = var_outr.yzw * var_outr.yzw;
