...
half4 var_E = var_colormap * inputVx.color;
	var_outr.a = var_colormap.a * (-inputVx.color.a) + 1;
	var_colormap.rgb = var_E.rgb * var_E.rgb;
	var_colormap.rgb = var_E.aaa * var_colormap.rgb;
	var_attenuation *= var_colormap.rgb;
	var_outr.a = (-var_outr.a) + 1;
	var_colormap.rgb = var_outr.aaa * fogColorLinear.xyz;

	outColor.w = var_outr.a;

	var_outr.rgb = var_attenuation * var_outr.rgb + (-var_colormap.rgb);

	outColor.xyz = inputVx.texcoord1.w * var_outr.rgb + var_colormap.rgb;
