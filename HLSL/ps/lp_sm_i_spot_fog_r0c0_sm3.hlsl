...
float4 var_L = var_shadowmapspotC + inputVx.texcoord4.z;
	...
	var_modellighting.xyz = var_modellighting.xyz * var_outr.a;
	...
	var_shadowmapspotA.w = lerp(lightSpotFactors.w, var_outr.r, var_modellighting.w);
...
half4 var_attenuation = tex2D(attenuationSampler, var_outr.a);
	...
	var_attenuation.xyz = var_shadowmapspotA.y * var_attenuation.xyz;
	var_shadowmapspotA.yzw = var_shadowmapspotA.w * var_attenuation.xxy;
	var_attenuation.xyz = var_shadowmapspotA.x * lightDiffuse.xyz;
