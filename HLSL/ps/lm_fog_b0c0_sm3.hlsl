...
half4 var_F = var_colormap * inputVx.color;
	var_lightmapsecondary.a = var_colormap.a * (-inputVx.color.a) + 1;
	var_colormap.rgb = var_F.rgb * var_F.rgb;
	var_colormap.rgb = var_F.aaa * var_colormap.rgb;
	var_colormap.a = (-var_lightmapsecondary.a) + 1;
	var_F.rgb = var_colormap.aaa * fogColorLinear.xyz;
	var_lightmapsecondary.rgb = var_colormap.rgb * var_lightmapsecondary.rgb + (-var_F.rgb);
	var_lightmapsecondary.rgb = inputVx.texcoord1.w * var_lightmapsecondary.rgb + var_F.rgb;
